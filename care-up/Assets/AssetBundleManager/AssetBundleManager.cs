...
#pragma warning restore
	        ...
	        if(GameObject.Find("TestSlider") != null)
            {
                ...
                GameObject.Find("testLoadText").GetComponent<Text>().text = ((fullDownloadSize - leftToDownload) / 1000000).ToString() + "MB/" +
                    (fullDownloadSize/1000000).ToString() + "MB";
                //print(progress);
            }
