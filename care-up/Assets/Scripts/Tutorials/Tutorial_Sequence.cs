        ...
        if (!Paused())
        {
            switch (currentStep)
            {
                ...
                case TutorialStep.MoveTo:
                    ...
                    {
                        player.tutorial_movedTo = false;
                        hintsBox.anchoredPosition = new Vector2(0f, 110f);
                ...
                case TutorialStep.PickSyringe:
                    ...
                    {
                        handsInventory.tutorial_pickedLeft = false;
                        hintsBox.anchoredPosition = new Vector2(24f, -122f);
                ...
                case TutorialStep.Talk:
                    ...
                    {
                        patient.tutorial_talked = false;
                        hintsBox.anchoredPosition = new Vector2(-375f, -297.08f);
                ...
                case TutorialStep.SequenceExplanation:
                    if (nextButtonClicked)
                    {
                        hintsBox.anchoredPosition = new Vector2(-484f, -41f);
